...
%     [avg_inner_0,avg_inner_1,avg_outter_0,avg_outter_1] = FlarePreJudge_regions_ROI_seg(lab_a);  
    ...
    r_g = image_double(:,:,1)./image_double(:,:,2);    
    [avg_inner_0,avg_inner_1,avg_outter_0,avg_outter_1] = FlarePreJudge_regions_ROI_rgb(r_g);    
...
%     P1_all_BAD(i) = p1;
     ...
     all_dis_rgb_pos = [all_dis_rgb_pos delt0];
     all_dis_rgb_pos = [all_dis_rgb_pos delt1];
%      if delt0>3 
%          flag0 = 'True';
%      else
%          flag0 = 'False';
