...
%     CR = YCBCR(:,:,3);
    ...
    [avg_inner_0,avg_inner_1,avg_outter_0,avg_outter_1] = FlarePreJudge_regions_ROI_rgb(h_plane);    
...
%     P1_all_BAD(i) = p1;
     ...
     all_dis_hsv_pos = [all_dis_hsv_pos delt0];
     all_dis_hsv_pos = [all_dis_hsv_pos delt1];
%      if delt0>3 
%          flag0 = 'True';
%      else
%          flag0 = 'False';
