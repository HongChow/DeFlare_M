function [lab_adjust_roi] = DeFlareCista_Core_V2(lab_roi,omg_l,light_mode)
...
%  figure,imshow(binary_data_a),title('binary_data_a');
...
% figure,imshow(color_a_adjust,[-128 128]),title('color_a');
% figure,imshow(color_a_adjust,[-128 128]),title('color_a_adjust');
omg_b = 0.75;
% sort_b = sort(color_b(:));
% sort_b
